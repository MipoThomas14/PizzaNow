...
public class FileHandlerTest {
    ...
    void readCustomerCSV() throws IOException{
        ...
        // assertEquals("1112223333", row0[0]);
        // assertEquals("John Doe", row0[1]);
        // assertEquals("CREDIT", row0[2]);

        // String[] row1 = rows.get(1);
        // assertEquals(3, row1.length, "Row 1 should have 3 columns");
        // assertEquals("4445556666", row1[0]);
        // assertEquals("Jane Doe", row1[1]);
        // assertEquals("DEBIT", row1[2]);

        // String[] row2 = rows.get(2);
        // assertEquals(3, row2.length, "Row 2 should have 3 columns");
        // assertEquals("7778889999", row2[0]);
        // assertEquals("Jill Doe", row2[1]);
        // assertEquals("CASH", row2[2]);
    }
